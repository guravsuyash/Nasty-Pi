...
<body>
        ...
        <div class="desktop-nav d-none d-sm-none d-md-none d-lg-block">
            <div class="container mosanaLimited-container g-0">
                <div class="row align-items-center">
                    ...
                    <div class="col-8">
                        <div class="text-end">
                            <a data-bs-toggle="collapse" href="#desktop-nav-btn" role="button" aria-expanded="false" aria-controls="collapseExample" class="nav-open-btn d-flex align-items-center justify-content-end">
                Menu <img src="images/hamburger.svg" class="img-fluid ms-2" alt="">
              </a>
                        </div>
                        <div class="collapse" id="desktop-nav-btn">
                            <nav>
                                ...
                                <a data-bs-toggle="collapse" href="#desktop-nav-btn" role="button" aria-expanded="false" aria-controls="collapseExample" class="nav-close-btn d-flex align-items-center justify-content-end">CLOSE <img
                    src="images/cross-icon.svg" class="img-fluid ms-2" alt=""></a>
                            </nav>
                        </div>
                    </div>
                </div>
        ...
        <div class="mobile-nav d-block d-sm-block d-md-block d-lg-none">
            <div class="container g-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-4">
                        <a data-bs-toggle="modal" data-bs-target="#mobile-btn" class="mb-nav-btn d-flex align-items-center justify-content-end">
            ...
            <!-- Modal -->
            <div class="modal fade" id="mobile-btn" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <section class="welcome-sec">
        <div class="d-none d-sm-none d-md-none d-lg-block">
            <img src="images/welcome-sec-img.png" class="img-fluid w-100" alt="">
        </div>
        <div class="d-block d-sm-block d-md-block d-lg-none">
            <img src="images/welcome-sec-img-sm.png" class="img-fluid w-100" alt="">
        </div>
        <div class="welcome-sec-content">
            <span>ELEVATING YOUR</span>
            <h1>ECOMMERCE <br> sTRATEGY </h1>
            <div class="primary-btn">
                <a href="#more_info" class="common-btn"><span>More Info</span></a>
            </div>
        </div>
        <div class="d-none d-sm-none d-md-none d-lg-block">
            <div class="welcome-slider-wrap">
                <div class="welcome-slider-items">
                    <div class="welcome-slider">
                        <h4>Competitive Edge</h4>
                        <p>Gain an edge with our innovative solutions, staying ahead in the e-commerce landscape.</p>
                    </div>
                </div>
                <div class="welcome-slider-items">
                    <div class="welcome-slider">
                        <h4>Innovative Strategies</h4>
                        <p>Harness tailored strategies, propelling you to the forefront of industry trends.</p>
                    </div>
                </div>
                <div class="welcome-slider-items">
                    <div class="welcome-slider">
                        <h4>Market Expansion</h4>
                        <p>Expand globally with our cost-effective solutions and in-depth market understanding.</p>
                    </div>
                </div>
                <div class="welcome-slider-items">
                    <div class="welcome-slider">
                        <h4>Expert Guidance</h4>
                        <p>Navigate complexities with our dedicated team, bringing 60+ years of collective expertise.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="d-none d-sm-none d-md-none d-lg-block">
            <a href="#">
                <div class="scroll-btn">
                    ...
                    <img src="images/scroll-line.svg" class="img-fluid" alt="">
                </div>
            </a>
        </div>
        <div class="d-block d-sm-block d-md-block d-lg-none">
            <div class="welcome-owl">
    ...
    <section class="aboutUs-sec" id="more_info">
        <div class="container-fluid g-0">
            <div class="d-block d-sm-block d-md-block d-lg-none text-center">
                <img src="images/about-sm-top-img.png" class="img-fluid" alt="">
            </div>
            <div class="row flex-wrap-reverse align-items-center g-0">
                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="about-us-left">
                        ...
                        <div class="d-block d-sm-block d-md-block d-lg-none">
                            <img src="images/about-left-img-sm.png" class="img-fluid" alt="">
                        </div>
                        <div class="about-us-left-content">
                            <p>"If you are a small business in need of support then Misura Ventures is the one-stop solution for all your problems. From developing the website to planning effective marketing strategies, Misura Ventures has truly helped us grow" - Sarah N</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="about-us-right-content second-common-sec">
                        <h6>ABOUT US</h6>
                        <h5>Elevating Brands, <br> One Click at a time</h5>
                        <p>At Misura Ventures Limited, our journey is rooted in a passion for elevating brands through strategic clicks. With a commitment to excellence, our team, boasting over 60 years of collective expertise, navigates the e-commerce landscape,
                            crafting innovative solutions. Each click propels your brand forward, expanding horizons and embracing global success. Join us in the pursuit of excellence – where every click defines a remarkable journey.</p>
                        <div class="secondary-btn">
                            <a href="our-story.php" class="common-btn"><span>More about us</span></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="our-expertise">
        <div class="second-common-sec container g-5">
            <h6>Our Expertise</h6>
            <h5>Navigating the Digital commerce landscape with our Ecommerce innovators</h5>
            <p>
                Our team of seasoned e-commerce innovators, each a specialist in their domain, brings a wealth of expertise to the table. Together, we navigate the dynamic landscape of online business, crafting bespoke strategies that resonate with your brand's unique
                identity.
                <br><br> At Misura Ventures, innovation is not just a buzzword; it's the essence of our approach. We go beyond conventional solutions, implementing cutting-edge technologies and strategies to stay ahead of industry trends. Whether you're seeking
                to enhance user experiences, streamline operations, or expand globally, our e-commerce experts are dedicated to guiding you towards sustainable success.
            </p>
        </div>
    </section>
    ...
    <section class="partnership-sec">
        <div class="d-none d-sm-none d-md-none d-lg-block">
            <video loop autoplay muted class="d-block">
        <source src="images/partnership-video.mp4" type="video/mp4">
      </video>
        </div>
        <div class="d-block d-sm-block d-md-block d-lg-none w-100">
            <video loop autoplay muted class="d-block w-100">
        <source src="images/partnership-video-sm.mp4" type="video/mp4">
      </video>
        </div>
        <div class="partnership-content">
            <div class="d-none d-sm-none d-md-none d-lg-block">
                <img src="images/partnership-content-bg.png" class="img-fluid" alt="">
            </div>
            <div class="second-common-sec">
                <h6>PARTNERSHIP</h6>
                <h5>Your partner <br> in online retail</h5>
                <p>We understand that thriving in the digital marketplace requires more than just services; it demands a true partnership. As your strategic ally, we bring tailored solutions, aligning with your unique goals and challenges.
                </p>
                <p>
                    In the realm of online retail, navigating complexities requires a reliable companion. At Misura Ventures, we go beyond transactional relationships. We immerse ourselves in your brand, co-creating strategies that resonate with your audience. Together, we pave the
                    way for growth, making every click a step towards a thriving online retail presence.</p>
                <div class="secondary-btn">
                    <a href="contact-Us.php" class="common-btn"><span>Get Started</span></a>
                </div>
            </div>
        </div>
        <div class="d-none d-sm-none d-md-none d-lg-block">
            <img src="images/partnership-right-img.png" class="img-fluid partnership-right-img" alt="">
        </div>
        <div class="d-block d-sm-block d-md-block d-lg-none w-100">
            <img src="images/partnership-right-img-sm.png" class="img-fluid w-100" alt="">
        </div>
    </section>

    <section class="servie-insight-sec">
        <div class="container-fluid g-0">
            <div class="row g-0">
                <div class="col-12 d-block d-sm-block d-md-block d-lg-none text-center">
                    <img src="images/servie-insight-right-sm.png" class="img-fluid" alt="">
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="servie-insight-content-sec">
                        <div class="d-none d-sm-none d-md-none d-lg-block">
                            <img src="images/servie-insight-left-img.png" class="img-fluid" alt="">
                        </div>
                        <div class="second-common-sec">
                            <h6>SERVICE INSIGHT</h6>
                            <h5>Our proven Strategies <br> & innovative solutions</h5>
                            <p>We foster meaningful connections and strive for high-quality output. Our philosophy revolves around reshaping work methodologies to enhance the core commercial divisions of your business. What sets us apart is our commitment
                                to collaborative transition planning, shared expertise, and transparent communication with our clients.</p>
                            <div class="secondary-btn">
                                <a href="services.php" class="common-btn"><span>Explore Our Services</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 d-none d-sm-none d-md-none d-lg-block">
                    <img src="images/servie-insight-right.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="contact-sec">
        <div class="d-none d-sm-none d-md-none d-lg-block">
            <img src="images/contact-top-img.png" class="img-fluid w-100" alt="">
        </div>
        <div class="d-block d-sm-block d-md-block d-lg-none">
            <img src="images/contact-top-img-sm.png" class="img-fluid w-100" alt="">
        </div>
                ...
                <div class="contact-flex">
                    <div class="contact-bottom-content">
                        <div class="contact-content-details-sec">
                            ...
                            <address>Misura Ventures Limited7 Patroklou <br>  KokkinouFlat/Office 21,Strovolos, <br> 2000, Nicosia, Cyprus</address>
                            <a href="mailto:info@misuraventures.com" class="mailto">info@misuraventures.com</a> <br>
                            <a href="tel:+357 22 009547" class="mt-lg-0 mt-2 d-block">+357 22 009547</a>
                        </div>
                        <div class="d-none d-sm-none d-md-none d-lg-block">
                            <img src="images/contact-content-img.png" class="img-fluid" alt="">
                        </div>
                        <div class="d-block d-sm-block d-md-block d-lg-none">
                            <img src="images/contact-content-img-sm.png" class="img-fluid" alt="">
                        </div>
                    </div>
            ...
            <div class="row g-0 footer-top-sec">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-5">
                    <div class="footer-right-sec">
                        ...
                        <p>© 2024 Misura Ventures Limited. <br> All rights reserved</p>
                    </div>
